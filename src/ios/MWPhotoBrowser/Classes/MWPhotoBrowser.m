...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if ([_delegate respondsToSelector:@selector(photoBrowserViewWillAppear)]) {
        // Call delegate method and let them dismiss us
        [_delegate photoBrowserViewWillAppear];
    }
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    if ([_delegate respondsToSelector:@selector(photoBrowserViewWillDisAppear)]) {
        // Call delegate method and let them dismiss us
        [_delegate photoBrowserViewWillDisAppear];
    }
