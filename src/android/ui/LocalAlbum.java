...
import com.tyrion.plugin.picker.common.StringUtils;
...
public class LocalAlbum extends BaseActivity {
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            if(LocalImageHelper.getInstance().getCurrentSize()+LocalImageHelper.getInstance().getCheckedItems().size()>= ExtraKey.IMAGE_CHOSE_COUNT){
                Toast.makeText(LocalAlbum.this,"最多选择" + ExtraKey.IMAGE_CHOSE_COUNT + "张图片", Toast.LENGTH_SHORT).show();
                return;
            }
